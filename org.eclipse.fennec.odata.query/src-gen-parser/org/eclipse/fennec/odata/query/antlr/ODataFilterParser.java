...
public class ODataFilterParser extends Parser {
	...
	public static final int
		...
		REF=29, WITH=30, AS=31, LPAREN=32, RPAREN=33, COMMA=34, SLASH=35, COLON=36, 
		DOT=37, DURATION=38, ENUM=39, GUID=40, DATETIMEOFFSET=41, DATE=42, TIMEOFDAY=43, 
		STRING=44, DECIMAL=45, INT=46, IDENT=47, ALIAS=48, WS=49;
	public static final int
		...
		RULE_castName = 7, RULE_apply = 8, RULE_applyTrafo = 9, RULE_aggregateItem = 10, 
		RULE_computeItem = 11, RULE_expr = 12, RULE_orExpr = 13, RULE_andExpr = 14, 
		RULE_notExpr = 15, RULE_comparison = 16, RULE_additive = 17, RULE_multiplicative = 18, 
		RULE_primary = 19, RULE_typeFunc = 20, RULE_qualifiedTypeName = 21, RULE_functionCall = 22, 
		RULE_memberPath = 23, RULE_lambdaCall = 24, RULE_literal = 25;
	private static String[] makeRuleNames() {
		return new String[] {
			"filter", "orderby", "orderbyItem", "resource", "keyPredicate", "keyLiteral", 
			"resourceSegment", "castName", "apply", "applyTrafo", "aggregateItem", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"WITH", "AS", "LPAREN", "RPAREN", "COMMA", "SLASH", "COLON", "DOT", "DURATION", 
	...
	public final CastNameContext castName() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_castName);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ApplyTrafoContext applyTrafo() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_applyTrafo);
		int _la;
		try {
			setState(165);
			_errHandler.sync(this);
	...
	public final AggregateItemContext aggregateItem() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_aggregateItem);
		try {
			setState(176);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ComputeItemContext computeItem() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_computeItem);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(178);
	...
	private AdditiveContext additive(int _p) throws RecognitionException {
		...
		int _startState = 34;
		enterRecursionRule(_localctx, 34, RULE_additive, _p);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	private MultiplicativeContext multiplicative(int _p) throws RecognitionException {
		...
		int _startState = 36;
		enterRecursionRule(_localctx, 36, RULE_multiplicative, _p);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final TypeFuncContext typeFunc() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_typeFunc);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final QualifiedTypeNameContext qualifiedTypeName() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_qualifiedTypeName);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 562679478485000L) != 0)) {
				{
				setState(288);
				expr();
				setState(293);
	...
	public final MemberPathContext memberPath() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_memberPath);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
