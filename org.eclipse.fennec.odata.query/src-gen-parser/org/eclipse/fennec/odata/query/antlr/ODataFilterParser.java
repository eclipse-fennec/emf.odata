...
public class ODataFilterParser extends Parser {
	...
	public static final int
		...
		VALUE=35, REF=36, FILTERQ=37, SEARCHQ=38, WITH=39, AS=40, FROM=41, MINUS=42, 
		LBRACE=43, RBRACE=44, LBRACKET=45, RBRACKET=46, LPAREN=47, RPAREN=48, 
		COMMA=49, EQUALS=50, SLASH=51, COLON=52, DOT=53, DQSTRING=54, NANLIT=55, 
		INF=56, BINARY=57, DURATION=58, ENUM=59, GUID=60, DATETIMEOFFSET=61, DATE=62, 
		TIMEOFDAY=63, STRING=64, DECIMAL=65, INT=66, IDENT=67, ANNOTATION=68, 
		ALIAS=69, WS=70;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"REF", "FILTERQ", "SEARCHQ", "WITH", "AS", "FROM", "MINUS", "LBRACE", 
			"RBRACE", "LBRACKET", "RBRACKET", "LPAREN", "RPAREN", "COMMA", "EQUALS", 
			"SLASH", "COLON", "DOT", "DQSTRING", "NANLIT", "INF", "BINARY", "DURATION", 
			"ENUM", "GUID", "DATETIMEOFFSET", "DATE", "TIMEOFDAY", "STRING", "DECIMAL", 
			"INT", "IDENT", "ANNOTATION", "ALIAS", "WS"
		};
	}
	...
	public final KeyLiteralContext keyLiteral() throws RecognitionException {
		...
		try {
			...
			setState(167);
			_la = _input.LA(1);
			if ( !(((((_la - 60)) & ~0x3f) == 0 && ((1L << (_la - 60)) & 639L) != 0)) ) {
	...
	public final ApplyTrafoContext applyTrafo() throws RecognitionException {
		...
		try {
			...
			case 16:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -17825128856420344L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 63L) != 0)) {
					{
					setState(400);
					boundCallArgs();
					}
	...
	public final SearchExprContext searchExpr() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 18155135997837320L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 15L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class CountCallContext extends ParserRuleContext {
		...
		public TerminalNode SEARCHQ() { return getToken(ODataFilterParser.SEARCHQ, 0); }
		public SearchExprContext searchExpr() {
			return getRuleContext(SearchExprContext.class,0);
		}
