 ...
 * @generated
 */
public class AggregateExpressionImpl extends MinimalEObjectImpl.Container implements AggregateExpression {
	/**
	...
	protected EClass eStaticClass() {
		return ApplyPackage.Literals.AGGREGATE_EXPRESSION;
	}
	...
	public NotificationChain basicSetExpression(OclExpression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ApplyPackage.AGGREGATE_EXPRESSION__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(OclExpression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ApplyPackage.AGGREGATE_EXPRESSION__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ApplyPackage.AGGREGATE_EXPRESSION__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplyPackage.AGGREGATE_EXPRESSION__EXPRESSION, newExpression, newExpression));
	}
	...
	public void setMethod(AggregateMethod newMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplyPackage.AGGREGATE_EXPRESSION__METHOD, oldMethod, method));
	}
	...
	public void setAlias(String newAlias) {
		...
		alias = newAlias;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplyPackage.AGGREGATE_EXPRESSION__ALIAS, oldAlias, alias));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ApplyPackage.AGGREGATE_EXPRESSION__METHOD:
				return getMethod();
