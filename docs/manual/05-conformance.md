...
| **4.0 Advanced** (§13.1.3) | ✅ **met** (clause re-audit 2026-07-14) | all MUSTs 1–12; SHOULDs 9.4–9.8 (expand options incl. `$levels`), 13 (async) and 14 (delta) met too — the only open SHOULD is cross-join (15) |
| **4.01 Advanced** (§13.2.3) | ✅ **met** (clause re-audit 2026-07-14) | ALL MUSTs and ALL SHOULDs — incl. select collection options (5.2–5.5), the `/$filter` segment (8) and nested parameter aliases (9) |
...
- **Cross-join** (`$crossjoin`, 4.0 Advanced SHOULD 15) — the single remaining spec SHOULD anywhere; parses and refuses honestly (501).
