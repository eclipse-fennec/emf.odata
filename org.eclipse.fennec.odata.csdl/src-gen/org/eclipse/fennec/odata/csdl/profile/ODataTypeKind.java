 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * The OData structural-type kind. ENTITY = has a key (EntityType), COMPLEX = no key (ComplexType), ENUM = EEnum (EnumType).
 * <!-- end-model-doc -->
 * @see org.eclipse.fennec.odata.csdl.profile.ProfilePackage#getODataTypeKind()
 * @model
 * @generated
 */
@ProviderType
